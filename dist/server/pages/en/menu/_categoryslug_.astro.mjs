...
const $$categorySlug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (category && category.slug.en && categorySlug !== category.slug.en) {
    return Astro2.redirect(`/en/menu/${category.slug.en}`);
  }
